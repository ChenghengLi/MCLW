...
output, but the residual variance is real. The headline tables
report only the clean / random-substitution / ZH back-translation
columns; a fully populated DIPPER column is deferred to the extended
version.
